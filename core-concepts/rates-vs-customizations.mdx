...
description: "ShipMagic offers two ways to optimize your checkout delivery experience: Shipping Rates and Shipping Customizations. Each serves a different purpose."
icon: "scale-balanced"
---
...
Requires [**CCS (Carrier Calculated Shipping)**](/installation-guide) to be enabled on your Shopify store.
