---
title: "What is ShipMagic?"
description: "Shipping Calculator: ShipMagic is a custom shipping rate calculator tool for Shopify. It allows you to create custom shipping rules to provide accurate and personalised shipping rates to your customers."
---

<img
  src="/logo/shipmagic-logo.png"
  alt="Shipmagic Logo"
  title="Shipmagic Logo"
  className="mx-auto"
  style={{ width:"48%" }}
/>
